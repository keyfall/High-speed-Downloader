...
"")
        ...
        self.horizontalLayout2.setContentsMargins(-1, 0, -1, 0)
        self.horizontalLayout2.setObjectName("horizontalLayout")
        self.label_2 = QtWidgets.QLabel(self.groupBox)
        self.label_2.setMinimumSize(QtCore.QSize(0, 21))
        self.label_2.setStyleSheet("color:rgb(0, 125, 255)")
        self.label_2.setTextFormat(QtCore.Qt.AutoText)
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout2.addWidget(self.label_2)
        self.lineEdit_file_name = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_file_name.setMinimumSize(QtCore.QSize(0, 21))
        self.lineEdit_file_name.setObjectName("lineEdit_file_name")
        self.horizontalLayout2.addWidget(self.lineEdit_file_name)
    ...
    def retranslateUi(self, Window):
        ...
        self.label_2.setText(_translate("Window", "下载文件名"))
        self.lineEdit_file_name.setPlaceholderText(_translate("Window", "请输入文件名"))
